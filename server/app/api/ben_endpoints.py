...
from app.prompts.prompts import BEN_PROMPT, WILL_RESUME
...
async def generate_response(request: PromptRequest, system_prompt = BEN_PROMPT, system_resume = WILL_RESUME):
    try:
